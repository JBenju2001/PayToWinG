        ...
        bl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!email.equals("") && !contra.equals("")) {
                            ...
                            addOnCompleteListener(LogActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(LogActivity.this, "correcto ", Toast.LENGTH_SHORT).show();
                                        //Preparamos todo para abrir el menu, la siguiente ventana y el usuario que pasaremos
                                        Intent i = new Intent(LogActivity.this, MenuActivity.class);
                    ...
                    Toast.makeText(LogActivity.this, "Email y contraseña necesarios.",
                            Toast.LENGTH_SHORT).show();
                }
